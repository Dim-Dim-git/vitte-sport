...
urlpatterns = [
    ...
    path('programs/<int:pk>/pdf/', views.program_pdf, name='program_pdf'),
    ...
    path('profile/coach/programs/', views.coach_programs, name='coach_programs'),
    path('profile/coach/programs/add/', views.program_edit, name='program_add'),
    path('profile/coach/programs/<int:pk>/', views.program_items, name='program_items'),
    path('profile/coach/programs/<int:pk>/edit/', views.program_edit, name='program_edit'),
    path('profile/coach/programs/<int:pk>/delete/', views.program_delete, name='program_delete'),
